...
HD_PWD='D:/Code/GLITCH-Software/FPGA/Telemetry_test/Telemetry_test.runs/I2C_Reader_NO_TX_inst_0_I2Cmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_Reader_NO_TX_inst_0_I2Cmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_Reader_NO_TX_inst_0_I2Cmod_0_0.tcl
