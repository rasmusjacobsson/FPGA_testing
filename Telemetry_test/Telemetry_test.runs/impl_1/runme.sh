...
HD_PWD='D:/Code/GLITCH-Software/FPGA/Telemetry_test/Telemetry_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TM_Block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TM_Block_wrapper.tcl -notrace
