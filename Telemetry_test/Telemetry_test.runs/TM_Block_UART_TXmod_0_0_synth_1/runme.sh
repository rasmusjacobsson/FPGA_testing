...
HD_PWD='D:/Code/GLITCH-Software/FPGA/Telemetry_test/Telemetry_test.runs/TM_Block_UART_TXmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TM_Block_UART_TXmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TM_Block_UART_TXmod_0_0.tcl
