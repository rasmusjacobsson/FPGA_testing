...
HD_PWD='D:/Code/GLITCH-Software/FPGA/Telemetry_test/Telemetry_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TM_Block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TM_Block_wrapper.tcl
