...
#
# Script generated by Vivado on Thu Aug 07 12:01:25 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : TM_Block_wrapper.sh
...
#
# Usage        : TM_Block_wrapper.sh
#                TM_Block_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TM_Block_wrapper.sh [-reset_run]
#                TM_Block_wrapper.sh [-reset_log]
#                TM_Block_wrapper.sh [-help]
#
...
# script info
echo -e "TM_Block_wrapper.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TM_Block_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L util_vector_logic_v2_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TM_Block_wrapper xil_defaultlib.TM_Block_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TM_Block_wrapper -key {Behavioral:sim_1:Functional:TM_Block_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/TM_Block.protoinst" -protoinst "protoinst_files/GNSS_Reader_NO_TX_inst_0.protoinst" -protoinst "protoinst_files/I2C_Reader_NO_TX_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TM_Block_wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TM_Block_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TM_Block_wrapper.sh [-help]\n\
Usage: TM_Block_wrapper.sh [-step]\n\
Usage: TM_Block_wrapper.sh [-lib_map_path]\n\
Usage: TM_Block_wrapper.sh [-reset_run]\n\
Usage: TM_Block_wrapper.sh [-reset_log]\n\
Usage: TM_Block_wrapper.sh [-keep_index]\n\
Usage: TM_Block_wrapper.sh [-noclean_files]\n\n\
