...
#                script (type 'SD_init_test.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/SPI/SD_Test/SD_Test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
