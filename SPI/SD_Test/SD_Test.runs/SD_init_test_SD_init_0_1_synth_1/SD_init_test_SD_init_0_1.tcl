...
OPTRACE "SD_init_test_SD_init_0_1_synth_1" START { ROLLUP_AUTO }
...
synth_design -top SD_init_test_SD_init_0_1 -part xc7a35tcpg236-1 -incremental_mode off -mode out_of_context
OPTRACE "synth_design" END { }
if { [get_msg_config -count -severity {CRITICAL WARNING}] > 0 } {
 send_msg_id runtcl-6 info "Synthesis results are not added to the cache due to CRITICAL_WARNING"
}

rename_ref -prefix_all SD_init_test_SD_init_0_1_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef SD_init_test_SD_init_0_1.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file SD_init_test_SD_init_0_1_utilization_synth.rpt -pb SD_init_test_SD_init_0_1_utilization_synth.pb"  } 
...
OPTRACE "SD_init_test_SD_init_0_1_synth_1" END { }
