...
HD_PWD='C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/SPI/SD_Test/SD_Test.runs/SD_init_test_SD_init_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_init_test_SD_init_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD_init_test_SD_init_0_1.tcl
