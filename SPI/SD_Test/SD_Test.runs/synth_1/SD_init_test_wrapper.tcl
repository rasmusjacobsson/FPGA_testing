...
synth_design -top SD_init_test_wrapper -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef SD_init_test_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file SD_init_test_wrapper_utilization_synth.rpt -pb SD_init_test_wrapper_utilization_synth.pb"  } 
