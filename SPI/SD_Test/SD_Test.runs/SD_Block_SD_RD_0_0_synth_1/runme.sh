...
HD_PWD='D:/Code/GLITCH-Software/FPGA/SPI/SD_Test/SD_Test.runs/SD_Block_SD_RD_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD_Block_SD_RD_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD_Block_SD_RD_0_0.tcl
