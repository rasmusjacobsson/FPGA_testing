...
HD_PWD='C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/UART/Read_GNSS/Read_GNSS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GNSS_Reader_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GNSS_Reader_wrapper.tcl -notrace
