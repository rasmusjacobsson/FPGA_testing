...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/UART/Read_GNSS/Read_GNSS.runs/GNSS_Reader_UART_TXmod_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GNSS_Reader_UART_TXmod_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GNSS_Reader_UART_TXmod_1_0.tcl
