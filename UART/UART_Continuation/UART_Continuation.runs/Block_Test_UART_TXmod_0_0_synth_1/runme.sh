...
HD_PWD='C:/Users/Sebastian Magnusson/Documents/GitHub/GLITCH-Software/FPGA/UART/UART_Continuation/UART_Continuation.runs/Block_Test_UART_TXmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Test_UART_TXmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Test_UART_TXmod_0_0.tcl
