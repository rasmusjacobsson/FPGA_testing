...
HD_PWD='D:/Code/GLITCH-Software/FPGA/UART/GNSS_and_UART/GNSS_and_UART.runs/Block_Test_MUX_2to1_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Test_MUX_2to1_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Test_MUX_2to1_0_4.tcl
