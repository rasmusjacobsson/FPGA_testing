...
HD_PWD='D:/Code/GLITCH-Software/FPGA/UART/GNSS_and_UART/GNSS_and_UART.runs/Block_Test_UART_TXmod_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Test_UART_TXmod_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Test_UART_TXmod_1_0.tcl
