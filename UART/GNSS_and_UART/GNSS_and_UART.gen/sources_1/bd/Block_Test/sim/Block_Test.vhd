...
entity Block_Test is
  ...
  attribute core_generation_info of Block_Test : entity is "Block_Test,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Block_Test,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
...
architecture STRUCTURE of Block_Test is
  ...
  signal MUX_2to1_0_mux_TX_signal_out : STD_LOGIC_VECTOR ( 7 downto 0 );
...
MUX_2to1_0: component Block_Test_MUX_2to1_0_4
     port map (
      i_TX_Byte_0(7 downto 0) => UART_RXmod_0_o_RX_byte(7 downto 0),
      i_TX_Byte_1(7 downto 0) => UART_RXmod_1_o_RX_byte(7 downto 0),
      i_TX_DV_0 => UART_RXmod_0_o_RX_DV,
      i_TX_DV_1 => UART_RXmod_1_o_RX_DV,
      mux_TX_DV_out => MUX_2to1_0_mux_TX_DV_out,
      mux_TX_out(7 downto 0) => MUX_2to1_0_mux_TX_signal_out(7 downto 0),
      sel => btn0,
      sysclk => sysclk
    );
...
UART_TXmod_0: component Block_Test_UART_TXmod_0_0
     port map (
      i_TX_Byte(7 downto 0) => MUX_2to1_0_mux_TX_signal_out(7 downto 0),
