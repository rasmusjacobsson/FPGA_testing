...
#
# Script generated by Vivado on Tue Aug 05 16:44:41 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Block_Test.sh
...
#
# Usage        : Block_Test.sh
#                Block_Test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Block_Test.sh [-reset_run]
#                Block_Test.sh [-reset_log]
#                Block_Test.sh [-help]
#
...
# script info
echo -e "Block_Test.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Block_Test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot Block_Test xil_defaultlib.Block_Test -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Block_Test -key {Behavioral:sim_1:Functional:Block_Test} -tclbatch cmd.tcl -protoinst "protoinst_files/Block_Test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Block_Test.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Block_Test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Block_Test.sh [-help]\n\
Usage: Block_Test.sh [-step]\n\
Usage: Block_Test.sh [-lib_map_path]\n\
Usage: Block_Test.sh [-reset_run]\n\
Usage: Block_Test.sh [-reset_log]\n\
Usage: Block_Test.sh [-keep_index]\n\
Usage: Block_Test.sh [-noclean_files]\n\n\
