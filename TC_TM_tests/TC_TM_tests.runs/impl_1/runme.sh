...
HD_PWD='D:/Code/FPGA_testing/TC_TM_tests/TC_TM_tests.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_RTC_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2C_RTC_test_wrapper.tcl -notrace
