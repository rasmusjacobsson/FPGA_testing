...
HD_PWD='D:/Code/FPGA_testing/TC_TM_tests/TC_TM_tests.runs/I2C_RTC_test_UART_TXmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_RTC_test_UART_TXmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_RTC_test_UART_TXmod_0_0.tcl
