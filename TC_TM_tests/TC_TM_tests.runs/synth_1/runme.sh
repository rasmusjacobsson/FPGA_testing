...
HD_PWD='D:/Code/FPGA_testing/TC_TM_tests/TC_TM_tests.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_RTC_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_RTC_test_wrapper.tcl
