...
#
# Script generated by Vivado on Wed Sep 03 11:25:50 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : I2C_RTC_test.sh
...
#
# Usage        : I2C_RTC_test.sh
#                I2C_RTC_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                I2C_RTC_test.sh [-reset_run]
#                I2C_RTC_test.sh [-reset_log]
#                I2C_RTC_test.sh [-help]
#
...
# script info
echo -e "I2C_RTC_test.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./I2C_RTC_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot I2C_RTC_test xil_defaultlib.I2C_RTC_test -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim I2C_RTC_test -key {Behavioral:sim_1:Functional:I2C_RTC_test} -tclbatch cmd.tcl -protoinst "protoinst_files/I2C_RTC_test.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb I2C_RTC_test.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./I2C_RTC_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: I2C_RTC_test.sh [-help]\n\
Usage: I2C_RTC_test.sh [-step]\n\
Usage: I2C_RTC_test.sh [-lib_map_path]\n\
Usage: I2C_RTC_test.sh [-reset_run]\n\
Usage: I2C_RTC_test.sh [-reset_log]\n\
Usage: I2C_RTC_test.sh [-keep_index]\n\
Usage: I2C_RTC_test.sh [-noclean_files]\n\n\
