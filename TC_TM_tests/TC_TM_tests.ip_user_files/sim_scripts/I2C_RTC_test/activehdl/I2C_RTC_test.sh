...
#                script (type 'I2C_RTC_test.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/TC_TM_tests/TC_TM_tests.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
