...
--Command     : generate_target RTC_test.bd
--Design      : RTC_test
...
entity RTC_test is
  ...
  attribute CORE_GENERATION_INFO of RTC_test : entity is "RTC_test,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=RTC_test,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of RTC_test : entity is "RTC_test.hwdef";
end RTC_test;

architecture STRUCTURE of RTC_test is
  component RTC_test_I2C_RTC_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component RTC_test_I2C_RTC_0_0;
  component RTC_test_I2Cmod_0_0 is
  port (
    sda_i : in STD_LOGIC;
    sda_o : out STD_LOGIC;
    sda_t : out STD_LOGIC;
  ...
  end component RTC_test_I2Cmod_0_0;
  component RTC_test_UART_TXmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component RTC_test_UART_TXmod_0_0;
...
begin
I2C_RTC_0: component RTC_test_I2C_RTC_0_0
     port map (
...
I2Cmod_0: component RTC_test_I2Cmod_0_0
     port map (
...
UART_TXmod_0: component RTC_test_UART_TXmod_0_0
     port map (
