...
HD_PWD='C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/data_length_test/data_length_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RTC_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RTC_test_wrapper.tcl
