...
HD_PWD='D:/Code/GLITCH-Software/FPGA/I2C/I2C_Test/I2C_Test.runs/I2C_Test_Read_Sensorsmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_Test_Read_Sensorsmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_Test_Read_Sensorsmod_0_0.tcl
