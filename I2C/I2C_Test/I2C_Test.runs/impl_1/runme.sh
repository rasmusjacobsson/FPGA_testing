...
HD_PWD='D:/Code/GLITCH-Software/FPGA/I2C/I2C_Test/I2C_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_Test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2C_Test_wrapper.tcl -notrace
