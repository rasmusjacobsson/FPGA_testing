...
HD_PWD='C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/Reboot_test/Reboot_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reboot_test_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reboot_test_block_wrapper.tcl
