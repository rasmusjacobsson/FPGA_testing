...
HD_PWD='C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/Reboot_test/Reboot_test.runs/reboot_test_block_reboot_control_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reboot_test_block_reboot_control_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reboot_test_block_reboot_control_0_0.tcl
