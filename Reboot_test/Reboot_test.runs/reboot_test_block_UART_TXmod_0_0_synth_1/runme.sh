...
HD_PWD='D:/Code/GLITCH-Software/FPGA/Reboot_test/Reboot_test.runs/reboot_test_block_UART_TXmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reboot_test_block_UART_TXmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reboot_test_block_UART_TXmod_0_0.tcl
