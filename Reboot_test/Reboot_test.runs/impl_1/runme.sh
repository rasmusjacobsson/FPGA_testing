...
HD_PWD='C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/Reboot_test/Reboot_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reboot_test_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reboot_test_block_wrapper.tcl -notrace
