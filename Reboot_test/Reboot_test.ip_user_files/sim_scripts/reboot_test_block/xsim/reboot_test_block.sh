...
#
# Script generated by Vivado on Thu Aug 07 19:05:49 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : reboot_test_block.sh
...
#
# Usage        : reboot_test_block.sh
#                reboot_test_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                reboot_test_block.sh [-reset_run]
#                reboot_test_block.sh [-reset_log]
#                reboot_test_block.sh [-help]
#
...
# script info
echo -e "reboot_test_block.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./reboot_test_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot reboot_test_block xil_defaultlib.reboot_test_block -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim reboot_test_block -key {Behavioral:sim_1:Functional:reboot_test_block} -tclbatch cmd.tcl -protoinst "protoinst_files/reboot_test_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb reboot_test_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./reboot_test_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: reboot_test_block.sh [-help]\n\
Usage: reboot_test_block.sh [-step]\n\
Usage: reboot_test_block.sh [-lib_map_path]\n\
Usage: reboot_test_block.sh [-reset_run]\n\
Usage: reboot_test_block.sh [-reset_log]\n\
Usage: reboot_test_block.sh [-keep_index]\n\
Usage: reboot_test_block.sh [-noclean_files]\n\n\
