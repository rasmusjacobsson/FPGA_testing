...
#                script (type 'reboot_test_block.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/rjaco/Documents/Skolgrejs/FPGA_testing/Reboot_test/Reboot_test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
